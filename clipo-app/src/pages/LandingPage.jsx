...
const SUBJECTS = [
  { icon: Calculator, name: 'Mathematics', color: '#6366f1', bg: 'rgba(99,102,241,0.1)', desc: 'Algebra, Calculus, Statistics & more' },
  { icon: Atom, name: 'Physics', color: '#4f8ef7', bg: 'rgba(79,142,247,0.1)', desc: 'Mechanics, Waves, Quantum & more' },
  { icon: FlaskConical, name: 'Chemistry', color: '#14b8a6', bg: 'rgba(20,184,166,0.1)', desc: 'Organic, Inorganic, Reactions & more' },
  { icon: Leaf, name: 'Biology', color: '#22c55e', bg: 'rgba(34,197,94,0.1)', desc: 'Cells, Genetics, Ecology & more' },
  { icon: Cpu, name: 'Computer Science', color: '#f59e0b', bg: 'rgba(245,158,11,0.1)', desc: 'Algorithms, Code, Data Structures' },
  { icon: Globe, name: 'History', color: '#ec4899', bg: 'rgba(236,72,153,0.1)', desc: 'World Events, Civilizations & more' },
  { icon: BookOpen, name: 'Literature', color: '#a78bfa', bg: 'rgba(167,139,250,0.1)', desc: 'Analysis, Poetry, Prose & more' },
  { icon: DollarSign, name: 'Economics', color: '#fb923c', bg: 'rgba(251,146,60,0.1)', desc: 'Micro, Macro, Markets & more' },
  { icon: Code, name: 'Coding', color: '#19c37d', bg: 'rgba(25,195,125,0.1)', desc: 'Web Dev, DSA, Projects & more' }
];

const STATS = [
  { icon: Users, value: '100+', label: 'Students' },
  { icon: Brain, value: '9+', label: 'Subjects' },
...
export default function LandingPage() {
  ...
  const faqs = [
    ...
    { q: 'How is it different from general chatbots?', a: 'Unlike general AI, Clipo uses subject-specific tutoring logic. Whether it\'s Mathematics or Coding, the AI adapts its teaching style to ensure conceptual clarity.' },
    { q: 'Can I upload images of my problems?', a: 'Yes! You can attach images of handwritten notes, complex formulas, or diagrams, and Clipo will analyze them to provide step-by-step solutions.' },
    { q: 'Is my learning data private?', a: 'Absolutely. Your data is secure and used only to personalize your learning experience. We prioritize student privacy above all else.' },
    { q: 'Does Clipo support multiple subjects?', a: 'Yes, we currently support Mathematics, Science, Engineering, Coding, and have a General category for everything else!' }
  ];
